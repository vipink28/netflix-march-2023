...
import { fetchNetflixOriginals, fetchPopularTv, fetchTopRatedTv, selectNetflixOriginals, selectPopularTv, selectTopRatedTv } from '../features/tv/tvSlice';
...
function Homescreen(props) {
    ...
    return (
        <>
            ...
            <Row title="Upcoming Movies" action={fetchUpcomingMovies} selector={selectUpcomingMovies} platform={keywords.movie}/>

            <Row title="Now Playing Movies" action={fetchNowPlayingMovies} selector={selectNowPlayingMovies} platform={keywords.movie}/>

            <Row title="Popular Tv" action={fetchPopularTv} selector={selectPopularTv} platform={keywords.tv}/>
